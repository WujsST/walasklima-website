...
import { QuizType, QuizAnswers } from '@/types/quiz';
...
const Quiz = () => {
    ...
    const allHomeQuestions: Question[] = [
        {
            id: 'buildingType',
    ...
    const allAutoQuestions: Question[] = [
        {
            id: 'vehicleType',
    ...
    const allPortableQuestions: Question[] = [
        {
            id: 'deviceType',
    ...
    const allDehumidifyQuestions: Question[] = [
        {
            id: 'reason',
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col justify-center items-center p-6 relative">
            ...
            <Link href="/" className="absolute top-8 left-8 flex items-center gap-2 text-dark font-medium hover:text-accent transition-colors">
                        ...
                        <div className="text-center animate-fade-in">
                            ...
                            >
                                ...
                                <p className="text-xs text-center text-gray-400 mt-4">
                                    Wysyłając formularz akceptujesz naszą <Link href="/polityka-prywatnosci" className="underline hover:text-dark">Politykę Prywatności</Link>.
                                </p>
                            </form>
                        </div>
                    )}
