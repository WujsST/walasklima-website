...
export const metadata: Metadata = {
  title: 'Polityka Prywatności i RODO - Walas Klimatyzacja',
  description: 'Polityka prywatności i ochrony danych osobowych firmy Walas Klimatyzacja. Informacje o przetwarzaniu danych zgodnie z RODO.',
};
