            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-sm border-l-2 border-primary/50 pl-4 py-1 italic opacity-80">
                        Profesjonalny serwis klimatyzacji.<br /> Z dojazdem do klienta w Łodzi i województwie łódzkim.
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        ...
                        <li>
                            <a href="mailto:klimatyzacja.mwalas@gmail.com" className="flex items-center gap-3 hover:text-accent transition-colors">
                                <div className="p-2 bg-white/5 rounded-lg"><Mail size={16} /></div>
                                <span>klimatyzacja.mwalas@gmail.com</span>
                            </a>
                        </li>
                        <li className="flex items-start gap-3">
                            <div className="p-2 bg-white/5 rounded-lg translate-y-1"><MapPin size={16} /></div>
                            <span>91-610 Łódź<br />ul. Beskidzka 170a</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><a href="/#klimatyzacja-domowa" className="hover:text-white transition-colors">Klimatyzacja stacjonarna</a></li>
                        <li><a href="/#auto-klimatyzacja" className="hover:text-white transition-colors">Auto klimatyzacja</a></li>
                        <li><a href="/#klimatyzacja-przenosna" className="hover:text-white transition-colors">Klimatyzacja przenośna</a></li>
                        <li><a href="/#osuszanie" className="hover:text-white transition-colors">Osuszanie pomieszczeń</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li><Link to="/polityka-cookies" className="hover:text-white transition-colors underline decoration-white/20 underline-offset-4">Polityka cookies</Link></li>
                        <li><Link to="/polityka-prywatnosci" className="hover:text-white transition-colors underline decoration-white/20 underline-offset-4">Polityka prywatności</Link></li>
                    </ul>
                </div>
