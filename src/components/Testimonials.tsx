      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full text-center lg:text-left">
          ...
          <p className="text-gray-500 font-sans max-w-md mx-auto lg:mx-0">
            Z dumą obsługujemy Łódź i okolice od lat. Naszym priorytetem jest uczciwość, terminowość i najwyższa jakość
            chłodzenia.
          </p>

          <a
            href="#kontakt"
            className="inline-flex mt-8 bg-dark text-white px-6 py-3 rounded-xl font-bold hover:bg-primary transition-colors"
          >
            Zostaw nam opinię
          </a>
        </div>
        ...
        <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
          {reviews.map((review, i) => (
            <div
              key={i}
              className={`bg-background p-6 rounded-3xl border border-gray-100 shadow-sm relative ${
                i === 2 ? 'hidden sm:block lg:hidden xl:block' : ''
              }`}
            >
